...
from appserver.apps.account import models   # noqa (4)
from appserver.apps.calendar import models  # noqa (4)
...
def do_run_migrations(connection: Connection) -> None:  #(1)
...
async def run_migrations_online() -> None:  # (1)
